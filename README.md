...
- 26 条规则自动识别敏感内容（密码 / API 密钥 / Slack/Discord/OpenAI 等 token / 身份证号等）
...
- **智能检测** — 26 条规则（关键词 + 正则），自动识别密码、API 密钥、Slack/Discord/OpenAI 等 token、私钥、身份证号、银行卡号等
